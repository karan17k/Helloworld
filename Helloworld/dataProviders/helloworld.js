...
(function() {
    var provider = app.data.helloworld = new Everlive({
            offlineStorage: true,
            appId: 'gakynggvpe809tvj',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'helloworld_access_token',
...
// START_CUSTOM_CODE_helloworld
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_helloworld